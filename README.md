...
### 2. Configuring email link hostname for Kiosk app
...
1. Change the "Base URL" field value to match your kiosk application hostname. Default is `https://habitatfitness-kiosk.dev.local`.
1. Save the item.
