...
1. Obtain a Firebase API key:
      ...
      - Click on the "gear" icon and access "project settings":
        <a href="https://github.com/Sitecore/Sitecore.HabitatHome.Omni/blob/master/fitness/app/docs/img/project-settings.png">Firebase Settings: <br/><img align="left"  src="https://github.com/Sitecore/Sitecore.HabitatHome.Omni/blob/master/fitness/app/docs/img/project-settings.png"/></a>
